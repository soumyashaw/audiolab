...
def test_model(feat_model_path, loss_model_path, part, add_loss, device):
    ...
    test_set = ASVspoof2019("LA", "/Users/soumyashaw/Documents/GitHub/audiolab/Auxillary_Code/ResNet18_2/Features/",
                            "/Users/soumyashaw/Documents/GitHub/audiolab/Auxillary_Code/ResNet18_2/LA/ASVspoof2019_LA_cm_protocols/", part,
    ...
    with open(os.path.join(dir_path, 'checkpoint_cm_score.txt'), 'w') as cm_score_file:
        for i, (lfcc, audio_fn, tags, labels) in enumerate(tqdm(testDataLoader)):
            ...
            for j in range(labels.size(0)):
                print(j, audio_fn[j], tags[j].data, "spoof" if labels[j].data.cpu().numpy() else "bonafide", score[j].item())
                cm_score_file.write(
    ...
    eer_cm, min_tDCF = compute_eer_and_tdcf(os.path.join(dir_path, 'checkpoint_cm_score.txt'),
                                            "/Users/soumyashaw/Documents/GitHub/audiolab/Auxillary_Code/ResNet18_2/")
